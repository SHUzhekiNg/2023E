...
Finally, calculate the TOPSIS Score and Ranking. Now that we have distance positive and distance negative. Then calculate the Topsis score for each row based on them in the end.
